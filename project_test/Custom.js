...
//   var yaMulti = $("td.yaMulti").text();
//   var ygMulti = $("td.ygMulti").text();
//   var fumbleMulti = $("td.fumbleMulti").text();   
...
//   var gamesTotal = $("tr.player3 td.games").text();
//   var gamesStartedTotal = $("tr.player3 td.gamesstarted").text();
//   var attsTotal = $("tr.player3 td.atts").text();
//   var yardsTotal = $("tr.player3 td.yards").text();
//   var tdTotal = $("tr.player3 td.td").text();
//   var firstDownsTotal = $("tr.player3 td.firstDowns").text();
//   var longTotal = $("tr.player3 td.long").text();
//   var yaTotal = $("tr.player3 td.ya").text();
//   var ygTotal = $("tr.player3 td.yg").text();
//   var fumbleTotal = $("tr.player3 td.fumble").text();
...
//   var yaCustom = (yaTotal / yaDiv) * yaMulti;
//   var ygCustom = (ygTotal / ygDiv) * ygMulti;
//   var fumbleCustom = (fumbleTotal / fumbleDiv) * fumbleMulti;

  

//   var custom = gamesCustom + gamesStartedCustom + attsCustom + yardsCustom + tdCustom + firstDownsCustom + longCustom + yaCustom + ygCustom + fumbleCustom


  
//   $("tr.player3 td.custom").text(custom);
...
$("button.customB").on( "click", function() {
  ...
  var gamesDiv = $("td.gamesDiv").text();
  var gamesStartedDiv = $("td.gamesStartedDiv").text();
  var attsDiv = $("td.attsDiv").text();
  var yardsDiv = $("td.yardsDiv").text();
  var tdDiv = $("td.tdDiv").text();
  var firstDownsDiv = $("td.firstDownsDiv").text();
  var longDiv = $("td.longDiv").text();
  var ypaDiv = $("td.ypaDiv").text();
  var ypgDiv = $("td.ypgDiv").text();
  var fumblesDiv = .25;
  // var ageDiv = $("td.ageDiv").text();
  var ybcDiv = $("td.ybcDiv").text();
  var ybcpaDiv = $("td.ybcpaDiv").text();
  var yacDiv = $("td.yacDiv").text();
  var yacpaDiv = $("td.yacpaDiv").text();
  // var brkTklDiv = $("td.brkTklDiv").text();
  // var attpBrkTlkDiv = $("td.attpBrkTlkDiv").text();
  var attsI20Div = $("td.attsI20Div").text();
  var yardsI20Div = $("td.yardsI20Div").text();
  var tdI20Div = $("td.tdI20Div").text();   
  // var perRushI20Div = $("td.perRushI20Div").text();
  var attsI10Div = $("td.attsI10Div").text();
  var yardsI10Div = $("td.yardsI10Div").text();
  var tdI10Div = $("td.tdI10Div").text();
  // var perRush10Div = $("td.perRushI10Div").text();
  var attsI5Div = $("td.attsI5Div").text();
  var yardsI5Div = $("td.yardsI5Div").text();
  var tdI5Div = $("td.tdI5Div").text();
  ...
  var custom = gamesCustom + gamesStartedCustom + attsCustom + yardsCustom + tdCustom + firstDownsCustom + longCustom + ypaCustom + ypgCustom + fumblesCustom + ybcCustom + ybcpaCustom + yacCustom + yacpaCustom + attsI20Custom + yardsI20Custom + tdI20Custom + attsI10Custom + yardsI10Custom + tdI10Custom + attsI5Custom + yardsI5Custom + tdI5Custom
