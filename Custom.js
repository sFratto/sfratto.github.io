$("button.customB").on( "click", function() {
  ...
  var yardsI20Multi = $("input.yardsI20Multi").val();
  var tdI20Multi = $("input.tdI20Multi").val();   
  // var perRushI20Multi = $("input.perRushI20Multi").val();
  var attsI10Multi = $("input.attsI10Multi").val();
  var yardsI10Multi = $("input.yardsI10Multi").val();
  var tdI10Multi = $("input.tdI10Multi").val();
  // var perRush10Multi = $("input.perRushI10Multi").val();
  var attsI5Multi = $("input.attsI5Multi").val();
  var yardsI5Multi = $("input.yardsI5Multi").val();
  var tdI5Multi = $("input.tdI5Multi").val();
  // var perRushI5Multi = $("input.perRushI5Multi").val();
  ...
  // $("tr.player" + i + " td.custom").text(gamesMulti);
